        ...
        <div className="main_container card">
            <div className="para0 card-body">
                    ...
                    <div className="main_content card">
                        ...
                        <h3 data-aos="flip-down" className='home_head_font'>Our Performance in Q3 2022</h3>
                        ...
                        <img className="picture" src="https://images.pexels.com/photos/920382/pexels-photo-920382.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" data-aos="zoom-out-right"/>
                    <div className="main_image"></div>
                </div>
            </div>
            <div className="para1 flex ">
                <h3 className='color' data-aos="slide-up">Thrive together</h3>
                <img src="https://www.natwestgroup.com/content/dam/natwestgroup_com/natwestgroup/images/new-images-2022/single-article/image.dim.360.Natwest_erp_camden_0051_445x275.jpg" className='image' data-aos="slide-up" width="500px"/>
            ...
            <div className="para1 flex card">
                ...
                <img src="https://www.natwestgroup.com/content/dam/natwestgroup_com/natwestgroup/images/image.dim.480.marcus-rashford-445x275.png" className='image' data-aos="slide-up" width="500px"/>
            ...
            <div className="para1 flex ">
                ...
                <img src="https://www.natwestgroup.com/content/dam/natwestgroup_com/natwestgroup/images/image.dim.480.our-brands.jpeg" className='image' data-aos="slide-up" width="500px"/>
            ...
            <div className="para1 flex ">
                ...
                <img src="https://www.natwestgroup.com/content/dam/natwestgroup_com/natwestgroup/images/image.dim.480.our_history_page.jpg"  className='image' data-aos="slide-up" width="500px"/>
            ...
            <div id="contactus" className="contact flex card">
                ...
                <img src="https://www.natwestgroup.com/content/dam/natwestgroup_com/natwestgroup/images/image.dim.360.who-we-are.jpeg" className='image' data-aos="slide-up" width="500px"/>
